...
namespace {
	...
	// TMS113 VARIANTARG *__thiscall IWzResMan::GetObjectA(struct IUnknown *this, VARIANTARG *pvargDest, int *a3, _DWORD *a4, _DWORD *a5);
	...
	// TMS113 VARIANTARG *__thiscall IWzProperty::GetItem(struct IUnknown *this, VARIANTARG *pvargDest, int *a3)
...
namespace ResMan {
	...
	bool Extend(Rosemary& r) {
		...
		SADDR(&_IWzResMan__GetObjectA, uGetObjectAddress); // TMS113(00404A75)
		SADDR(&_IWzProperty__GetItem, uGetItemAddress); // TMS113(0040481D)
		return true;
	}
